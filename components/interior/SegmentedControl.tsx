/* Interior registry source: segmented-control · https://www.interior.dev/docs/segmented-control */
/* eslint-disable react-hooks/refs -- registry source intentionally keeps the latest change callback in a ref */
"use client";
...
export function SegmentedControl({
  ...
  return (
    <div
      role="radiogroup"
      aria-label={label}
      className={`relative inline-block select-none rounded-[9px] bg-stone-100/70 p-[3px] dark:bg-[#1D1D1A] ${className}`}
    >
      <div
        ...
        >
          {options.map((option, i) => (
            <button
              ...
              className="cursor-default rounded-[6px] outline-none focus-visible:bg-stone-900/[0.06] disabled:cursor-not-allowed disabled:opacity-55 dark:focus-visible:bg-white/[0.08]"
            >

/* Interior registry source: copy-button · https://www.interior.dev/docs/copy-button */
/* eslint-disable react-hooks/refs -- registry source intentionally keeps latest callbacks in refs */
"use client";

...
/* Interior registry source: slider-detents · https://www.interior.dev/docs/slider-detents */
/* eslint-disable react-hooks/refs -- registry source uses refs for live drag callbacks and label continuity */
"use client";
  ...
  return (
    <div className={`w-full select-none ${className}`}>
      ...
      <div
        ref={trackRef}
        {...trackProps}
        className={`relative h-9 w-full rounded-[9px] outline-none focus-visible:bg-stone-100/80 dark:focus-visible:bg-white/[0.06] ${
          disabled
